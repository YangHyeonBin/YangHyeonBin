...
function generateWeeklyContributionsSection(
    ...
    section += `| | ${lang === "ko" ? "레포 수" : "Repos"} | ${
        lang === "ko" ? "기여 수" : "Contributions"
    } |\n`;
    section += `|:---|:---:|:---:|\n`;
...
async function main() {
    ...
    try {
        ...
        console.log(
            `  ✅ 레포별 기여: Public ${summary.publicRepoCount}개(${summary.publicCommits}), Private ${summary.privateRepoCount}개(${summary.privateCommits})`
        );
    } catch (e) {
    ...
    if (weeklyContributionsByRepo) {
        ...
        const totalContributions =
            summary.publicCommits + summary.privateCommits;
